...
public class Todo {
    ...
    public static Todo create(UUID id, String title, String description, LocalDate dueDate) {
        Todo todo = new Todo();
        todo.applyChange(new TodoCreatedEvent(id, title, description, dueDate, 0L), true);
        return todo;
    }
    ...
    public void update(String title, String description, LocalDate dueDate) {
        ...
        this.applyChange(new TodoUpdateEvent(this.id, title, description, dueDate, this.version + 1), true);
    }
