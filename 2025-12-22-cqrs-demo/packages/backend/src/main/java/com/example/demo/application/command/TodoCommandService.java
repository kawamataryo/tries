...
public class TodoCommandService {
    ...
    @Transactional
    public UUID createTodo(String title, String description, LocalDate dueDate) {
        UUID id = UUID.randomUUID();
        Todo todo = Todo.create(id, title, description, dueDate);
    ...
    @Transactional
    public void updateTodo(UUID todoId, String title, String description, LocalDate dueDate) {
        Todo todo = loadTodo(todoId);
